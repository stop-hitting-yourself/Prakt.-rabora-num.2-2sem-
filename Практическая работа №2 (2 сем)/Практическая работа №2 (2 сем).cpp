...
void workWithList() {
	...
	do {
		...
		case 1: {
			...
			cin >> k;
			while (k < 0) {
				cout << "Размер списка не может быть отрицательным! Введите новое значение:" << '\n';
				cin >> k;
			}
			...
			do {
				...
				cout << "9 - показать время поиска элемента списка по значению и по номеру" << '\n';
				cout << "0 - для выхода" << '\n';
				cin >> w;
				switch (w) {
				case 1:
...
void workWithArray() {
	...
	do {
		...
		case 1: {
			...
			cin >> length;
			while (length < 0) {
				cout << "Размер массива не может быть отрицательным! Введите новое значение:" << '\n';
				cin >> length;
			}
			...
			do {
				...
				cout << "9 - показать время поиска элемента динамического массива по значению и по номеру" << '\n';
				cout << "0 - для выхода" << '\n';
				cin >> w;
				switch (w) {
				case 1:
